...
void inputLinkTerms(linkedPolynomialTerm*& polyPtr, int coef, int expo)////3 3 0 3 2 3 4 4 0 4 0 5 5 5 0 0
{
	linkedPolynomialTerm* tmpPtr;
	...
	if (polyPtr==nullptr || polyPtr->expo <= expo) {  
